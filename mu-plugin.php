...
add_action( 'admin_notices', function () {
	...
	<div style="background:#1a1a1a;border:4px solid #b8960c;margin:10px 0 20px;overflow:hidden;">
		...
		<div style="padding:16px 24px;color:#e8dcc8;">
			<p style="font-family:'IM Fell English',serif;font-style:italic;font-size:22px;font-weight:normal;margin:0 0 14px;line-height:1.8;color:#e8dcc8;">Your page builder produces a hero that looks perfect on every screen. But has it created an img tag? Without one, there is no srcset — and without srcset, every visitor downloads the same full-resolution file.</p>
